...
<script>
    ...
    Swal.fire({
        ...
        showConfirmButton: false, // نخفي الزر عشان نعتمد على الوقت
        timer: 2000 // الرسالة ستبقى لمدة ثانيتين (2000 مللي ثانية)
    });

    // 2. انتظر ثانيتين (نفس مدة الرسالة) قبل الانتقال للصفحة الأخرى
    setTimeout(function() {
